        ...
        {cardDetails.map((cardDetail, index) => (
          <CarouselItem key={index} className="basis-1/ lg:basis-1/3  w-[167.5px]   md:max-w-[335px] md:min-w-[290px] mx-2     ">
            ...
            <CardDescription className=" w-full  h-full flex flex-col items-start justify-evenly py-3 gap-2 "  >
              <h1 className="text-white text-[7.7px] md:text-[15.58px] font-medium leading-[10.91px] md:leading-[21.81px] " >{cardDetail.heading} </h1>
              <p className="text-utility-blogDescription text-[8.31px] md:text-[16.62px] font-medium leading-[12.46px] md:leading-[24.93px] font-urbanist  " >{cardDetail.description} </p>
              <a href={cardDetail.link} className="text-utility-blogLink text-[7.63px] md:text-[15.27px] font-semibold font-urbanist flex items-center gap-2 md:leading-[15.24px] leading-[7.62px] " > <span>Read more</span> <span><ArrowRight/></span> </a>
            </CardDescription>
