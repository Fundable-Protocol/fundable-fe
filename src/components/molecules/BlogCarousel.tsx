    ...
    >
      <CarouselContent className="w-full">
        {cardDetails.map((cardDetail, index) => (
          ...
          >
            <Card className="w-[167.5px] md:min-w-[290px] lg:w-[335px] h-[199px] md:h-[398px] bg-white dark:bg-utility-blogCard border border-utility-cardBorder backdrop-blur-[40%] rounded-[15px] p-0">
              <CardContent className="relative w-full h-full flex flex-col items-center justify-stretch gap-3 rounded-[15px] px-2 py-1">
                ...
                <CardDescription className="w-full h-full flex flex-col items-start justify-evenly py-3 gap-2">
                  <h1 className=" text-black dark:text-white text-[7.7px] md:text-[15.58px] font-medium leading-[10.91px] md:leading-[21.81px]">
                    {cardDetail.heading}
                  </h1>
                  <p className="text-gray-500 dark:text-utility-blogDescription text-[8.31px] md:text-[16.62px] font-medium leading-[12.46px] md:leading-[24.93px] font-urbanist">
