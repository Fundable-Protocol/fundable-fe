...
function Utilities() {
  return (
    <main className=" text-black dark:text-white p-4 md:p-8 lg:p-12 relative -mt-0 ">
      <div className="max-w-7xl mx-auto">
        <div className="w-full flex flex-row md:justify-between justify-center items-center gap-8">
          ...
          <p className="font-normal text-[1rem] text-center lg:text-right text-gray-500 dark:text-utility-description max-w-[600px] md:block hidden">
